...
> Not: Mevcut repoda şematik PNG'leri kök dizinde duruyor (ileride `schematic/` klasörüne taşınabilir).
...
> Not: Mevcut repoda PCB görselleri kök dizinde duruyor (ileride `pcb/` klasörüne taşınabilir).

![2D PCB Düzeni](./2d%20kart.png)

---

## Mekanik Tasarım & Kasa

> Not: `mechanical/` klasörü repoda bulunamadı. Eğer görseller eklersen linkleri güncelleyebilirim.

---

## Dosya Yapısı

> Not: Bu bölüm, hedeflenen klasör yapısını gösterir. Şu an repoda görsellerin çoğu kök dizinde.
